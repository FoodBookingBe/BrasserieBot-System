...
var CoreController = function () {
    var _classDecorators = [(0, common_1.Controller)('core')];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var _instanceExtraInitializers = [];
    var _getHello_decorators;
    var CoreController = _classThis = /** @class */ (function () {
        function CoreController_1() {
            __runInitializers(this, _instanceExtraInitializers);
        }
        CoreController_1.prototype.getHello = function () {
            return 'Hello Core!';
        };
        return CoreController_1;
    }());
