          ...
          <div className="flex flex-col items-center md:items-end">
            <div className="flex items-center space-x-4 mb-2">
              <a href="https://github.com/BrasserieBot-System" target="_blank" rel="noopener noreferrer"
                 className="text-gray-600 hover:text-gray-900" title="GitHub">
              ...
              <a href="https://app.netlify.com/sites/foodbookingai/deploys" target="_blank" rel="noopener noreferrer"
                 className="text-gray-600 hover:text-gray-900" title="Netlify Deploys">
            ...
            <a
              ...
              className="inline-block netlify-status-image" title="Netlify Status"
            >
